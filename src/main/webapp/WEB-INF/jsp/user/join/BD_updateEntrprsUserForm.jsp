...
<script type="text/javascript">
	...
	var customValidate = function() {
		...
		if($("#userPswd").val() != '' && !opCheckConfirmPassword())
			return false;

		// 비밀번호 유효성 체크
		if($("#userPswd").val() != '' && $("#allowPasswdCheckVal").val() != 'Y') {
...
<body>
	...
	<form name="dataForm" id="dataForm" method="post" action="ND_updateEntrprsUser.do" class="form-horizontal">
		<input type="hidden" name="userSttsSn" value="${dataVo.userSttsSn}" />
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-xs-9">
						<div class="row">
							<div class="col-xs-6">
								<input type="password" name="userPswd" id="userPswd" value="" class="form-control" placeholder="사용자비밀번호" />
				...
				<div class="form-group">
					<label for="confirmPassword" class="control-label col-xs-3">
						<span class="mandatory" id="passwordStar"></span> 사용자비밀번호 확인
					</label>
					<div class="col-xs-9">
						<div class="row">
							<div class="col-xs-6">
