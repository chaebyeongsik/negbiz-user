...
<op:jsTag type="libs" items="form, validate, ckeditor, tags" />
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // radio 버튼 선택 값 설정
        opChecked("rlsYn", "Y");
        opChecked("cprgtUseYn", "${dataVo.cprgtUseYn}", "N");
    });
            ...
            <form name="dataForm" id="dataForm" method="post" enctype="multipart/form-data" action="${ACTION}" class="form-horizontal">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <c:if test="${column.ntcPstYn.inptIndctYn eq 'Y'}" >
                        ...
                        <c:if test="${column.pstgBgngDt.inptIndctYn eq 'Y'}" >
                        <div class="form-group">
                            <bbs:pstgBgngDt type="label" />
                            <div class="col-sm-10">
                                <bbs:pstgBgngDt type="form" obj="${dataVo}" />
                                <bbs:pstgBgngDt type="desc" />
                            </div>
                        </div>
                        </c:if>
                        <c:if test="${column.pstgEndDt .inptIndctYn eq 'Y'}" >
                        <div class="form-group">
                            <bbs:pstgEndDt  type="label" />
                            <div class="col-sm-10">
                                <bbs:pstgEndDt  type="form" obj="${dataVo}" />
                                <bbs:pstgEndDt  type="desc" />
                            </div>
                        </div>
                        </c:if>
                        <c:if test="${column.rlsYn.inptIndctYn eq 'Y'}" >
                        <div class="form-group">
                            <bbs:othbc type="label" />
                            <div class="col-sm-10">
                                <bbs:othbc type="form" obj="${dataVo}" />
                                <bbs:othbc type="desc" />
                            </div>
                        </div>
                        </c:if>
