...
<op:jsTag type="user" items="base, opform, opvalidate" />
<op:jsTag type="libs" items="form, validate, ckeditor, captcha" />
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <op:fileUpload view="multi" />
                    </div>
                </div>

                <div class="form-group">
                    <label for="fileSns" class="control-label col-md-2">Captcha</label>
                    <div class="col-md-10">
                            <div id="opCaptChaPan"></div>
                    </div>
                </div>
